    ...
    public class AppUtils
    {
        ...
        public static string ConnectionString
        {
            get
            {
                ...
                {
                    connectionString = "server=localhost;database=bill;User ID=root;Password=dev;Charset=utf8; Allow Zero Datetime=True;OldSyntax=true;port=3306;Character Set=utf8";
                }
