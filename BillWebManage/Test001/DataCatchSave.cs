...
namespace Test001
{
    ...
    public class DataCatchSave
    {
        ...
        internal static string SaveData(string suser, CallBackMsg callBack, bool onlyAdd = true)
        {
            ...
            using (DbHelper db = new DbHelper(AppUtils.ConnectionString, true))
            {
                try
                {
                    ...
                    BuildBillDataFromTable(suser, onlyAdd, table, billList, detailList, db, ids);
        ...
        private static void BuildBillDataFromTable(string suser, bool onlyAdd, DataTable table, HashObjectList billList, HashObjectList detailList, DbHelper db = null, string ids = null)
        {
