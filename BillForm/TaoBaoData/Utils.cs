...
namespace TaoBaoData
{
    ...
    {
        private static string connect = "server=localhost;database=bill;User ID=root;Password=200153mysqlbill;Charset=utf8; Allow Zero Datetime=True;OldSyntax=true;port=3306;Character Set=utf8";
