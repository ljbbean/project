...
namespace TaoBaoData
{
    ...
    {
        private static string connect = "server=localhost;database=billtest;User ID=root;Password=dev;Charset=utf8; Allow Zero Datetime=True;OldSyntax=true;port=3306;Character Set=utf8";
